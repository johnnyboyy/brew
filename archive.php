    ...
    <div class="container">
			...
			<div id="content" class="row clearfix">
						...
						<div id="main" class="col-md-8 col-lg-9 clearfix" role="main">
							...
							<?php if ( $post_index != 0 && $post_index % 2 == 0 || ($post_index +1) == sizeof($posts) && sizeof($posts) > 1) { ?>
								</div> <!-- 2-col row end -->
							<?php } ?>

							<?php if (sizeof($posts) == $post_index +1 || $post_index == ( intval( get_option('posts_per_page') ) - 1 ) || $post_index == 0) { ?>
								</div> <!-- row end -->
							<?php } ?>
